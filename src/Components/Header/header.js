	...
	return (
		...
		>
			...
			<ul>
				...
				<li>
					You can create more layout components on: /src/Layouts. See the about
					page example.
				</li>
				<li>
					Using react context to pass some data to the about page (example) you
					can use it to pass any other global data you need.
				</li>
